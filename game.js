...
var spacer = {
  ...
  line: function (lineLength, character) {
    var line =
      "==================================================================";
...
// console.log(user);
// console.log(user.addSession("2022-07-05", 40));
// console.log(user.addSession("2022-07-06", 120));
// it returns the total duration on all sessions!
